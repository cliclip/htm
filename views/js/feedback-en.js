...
var reformal_wdg_domain   = "cliclip";
var reformal_wdg_mode    = 0;
var reformal_wdg_title   = "cliclip";
var reformal_wdg_ltitle  = "Feedback";
var reformal_wdg_lfont   = "";
var reformal_wdg_lsize   = "";
var reformal_wdg_color   = "#a0a0a0";
var reformal_wdg_bcolor  = "#516683";
var reformal_wdg_tcolor  = "#FFFFFF";
var reformal_wdg_align   = "right";
var reformal_wdg_waction = 0;
var reformal_wdg_vcolor  = "#9FCE54";
var reformal_wdg_cmline  = "#E0E0E0";
var reformal_wdg_glcolor  = "#105895";
var reformal_wdg_tbcolor  = "#FFFFFF";
var reformal_wdg_bimage = "3965207478e6a58f7c87af5d49a0c165.png";

// http://idea.informer.com/tab6.js?domain=cliclip
...
var _tempBuff = '';
function ref_du(){ var r = _tempBuff; _tempBuff = ''; return r; }
function ref_ud(a){ _tempBuff += a; }
...
if (dref_ext_img_m && reformal_wdg_bimage.indexOf( 'idea.informer.com/files/', 0 ) > 0) {
  dref_ext_img_m = 0; var v = reformal_wdg_bimage.toString().split ( '/' ); reformal_wdg_bimage = v[v.length-1]; }
...
MyOtzivCl = function() {
  ...
  this.mo_showframe = function() {
    ...
    ref_ud("<div style=\"position: fixed; top: 50%; left: 50%;\">");
