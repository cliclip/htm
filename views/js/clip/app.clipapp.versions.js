App.versions = (function($){
  var versions = {};
	...
	message : {
	  ...
	  weibo_sucmsg   :"恭喜您，关联 %s 微博帐号已成功，在新浪微博中@clickdang就可以收录了，现在就去@一条<a href='http://weibo.com' target='_blank'>试试?</a>",
	  twitter_sucmsg :"恭喜您，关联 %s Twitter帐号已成功，您的Twitter收藏可以收录到点忆了，现在就去收藏一条<a href='http://twitter.com' target='_blank'>试试?</a>",
